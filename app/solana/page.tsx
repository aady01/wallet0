...
export default function HdWallet() {
  ...
  return (
    ...
    >
      ...
      <div className="fixed top-0 w-full h-16 md:h-20 flex flex-col justify-center items-center backdrop-blur-lg bg-gradient-to-r from-white/80 via-white/70 to-white/80 dark:from-black/80 dark:via-gray-900/70 dark:to-black/80 z-10 border-b border-gray-200/50 dark:border-gray-800/50 px-4 py-2 shadow-sm">
